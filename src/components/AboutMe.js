...
export default function AboutMe() {
  ...
  return (
    <div ref={ref} id='aboutme' className='flex flex-col md:flex-row w-full justify-center items-center'>
      ...
      <motion.p animate={textControls} initial="right_hidden" variants={variants} className='flex-1 p-32 md:bg-zinc-300 md:rounded-l-full text-lg font-extralight'>Hi! My name is André and I've been programming since 2013, first I started with
